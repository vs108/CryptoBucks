    ...
    <div className='w-full h-12 border-2 border-gray-100 rounded-lg flex items-center justify-between relative'>
        ...
        <div className='flex mr-7'>
            ...
            <button type='submit' className='ml-1 cursor-pointer'>
                <img src={submitIcon} alt='submit' className='w-full h-auto'></img>
            </button>
            </form>
        ...
        <label className='relative flex justify-center items-center '>
            ...
            <select name='sortby' className='rounded bg-gray-200 text-base pl-2 pr-10 py-0.5 leading-4 capitalize focus:outline-0'
            onClick={handleSort}>
            ...
            <img src={selectIcon} alt='submit' className='w-[1rem] h-auto absolute right-1 top-2 pointer-events-none'></img>

        </label>

        <button className='w-[2rem] ml=2 hover:scale-110 transition-all transition-ease
         relative mr-4' onClick={resetFunction}>
        <svg
